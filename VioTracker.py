...
class VioTracker:
    ...
    def get_face_location(self):
        ...
        face_location = [top_right_x, top_right_y, bottom_left_x, bottom_left_y]
        return face_location

    def get_video(self):
        video = numpy.random.randint(
            low=0, high=256, size=(self.frames_per_video, 3, 1048, 1048)
        )  # generate a random video with 10 frames of 3dim (RGB) 1048*1048 frames
        return video
